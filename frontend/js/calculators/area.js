 ...
 * Area Converter
 *
 * Converts between area units using UnitConverter utility
 */
...
class AreaConverter {
    ...
    convert() {
        ...
        if (value < 0) {
            this.toValue.value = 'Error: Area cannot be negative';
            return;
        }

        try {
            // Use UnitConverter utility
            const result = UnitConverter.area.convert(value, fromUnit, toUnit);
